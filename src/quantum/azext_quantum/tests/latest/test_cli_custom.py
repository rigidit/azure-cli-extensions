...
class QuantumCliTest(ScenarioTest):
    ...
    def test_cli(self):
        ...
        test_workspace_v2 = "ws-v2-test-eastus2euap"
        test_location_v2 = "eastus2euap"
        test_resource_group_v2 = "e2e-scenarios"
        test_storage_v2 = "lbchyvfoh5j4u"
    ...
    def test_cli_scenarios(
        ...
        execute_results = self.cmd(
            f"az quantum execute -g {resource_group} -w {ws_name} -t {target} --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --job-params priority=High tags=cli,test --entry-point ENTRYPOINT__main -o json"
        ).get_output_in_json()
        ...
        run_results = self.cmd(
            f"az quantum run -g {resource_group} -w {ws_name} -t {target} -l {location} --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --job-params priority=Standard tags=cli,test --entry-point ENTRYPOINT__main -o json"
        ).get_output_in_json()
        ...
        job_submit_results = self.cmd(
            f"az quantum job submit -g {resource_group} -w {ws_name} -t {target} --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --entry-point ENTRYPOINT__main --job-params priority=High tags=cli,test -o json"
        ).get_output_in_json()
        ...
        job_submit_results = self.cmd(
            f"az quantum job submit -g {resource_group} -w {ws_name} -l {location} -t {target} --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --entry-point ENTRYPOINT__main -o json"
        ).get_output_in_json()
        ...
        job_submit_results = self.cmd(
            f"az quantum job submit -g {resource_group} -w {ws_name} -t {target} --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --entry-point ENTRYPOINT__main --job-params priority=Standard tags=cli,test -o json"
        ).get_output_in_json()
        print(f"job submit results: {job_submit_results}\n")
        ...
        job_name = "cli-job-ccnot1-" + datetime.now().isoformat()
        job_submit_results = self.cmd(
            f"az quantum job submit --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --entry-point ENTRYPOINT__main -o json"
        ).get_output_in_json()
        print(f"job submit results: {job_submit_results}\n")
        ...
        job_name = "cli-job-ccnot1-" + datetime.now().isoformat()
        job_submit_results = self.cmd(
            f"az quantum job submit --job-name {job_name} --job-input-format qir.v1 --job-input-file c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc --entry-point ENTRYPOINT__main --job-params priority=High tags=cli,test -o json"
        ).get_output_in_json()
        print(f"job submit results: {job_submit_results}\n")
    ...
    def test_cli_scenarios_using_operations(
        ...
        job_input_file = "c:/repos/github/azure-cli-extensions/src/quantum/azext_quantum/tests/latest/input_data/ccnot.bc"
    ...
    def test_cli_submit_with_disabled_then_enabled_storage_key_access(self):
        ...
        test_storage_temp = (
            "e2etests47140761"  # "e2etests" + str(random.randint(10000000, 99999999))
        )
        ...
        self.cmd(
            f"az quantum workspace set -g {test_resource_group} -w {test_workspace_temp} -l {test_location}"
        )
        ...
        results = self.cmd(
            "az quantum job submit -t rigetti.sim.qvm --job-input-format rigetti.quil.v1 --job-input-file input_data/bell-state.quil --job-output-format rigetti.quil-results.v1 -o json"
        ).get_output_in_json()
        self.assertIn("id", results)

        job = self.cmd(
            f"az quantum job show -j {results['id']} -o json"
        ).get_output_in_json()
        ...
        updated = self.cmd(
            f"az storage account update -g {test_resource_group} -n {test_storage_temp} --allow-shared-key-access true -o json"
        ).get_output_in_json()
        self.assertTrue(
            updated["allowSharedKeyAccess"],
            "Access keys should be enabled after update",
        )
    ...
    def test_cli_submit(self):
        ...
        results = self.cmd(
            "az quantum job submit -t rigetti.sim.qvm --job-input-format rigetti.quil.v1 -t rigetti.sim.qvm --job-input-file input_data/bell-state.quil --job-output-format rigetti.quil-results.v1 -o json"
        ).get_output_in_json()
